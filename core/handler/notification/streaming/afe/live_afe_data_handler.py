...
class LiveAfeDataHandler:
    ...
    def handle(
        ...
        ppg_streaming_callbacks = [callback for callback in streaming_callbacks if
                                   callback.sensor_type == SensorType.PPG]

        ecg_streaming_callbacks = [callback for callback in streaming_callbacks if
                                   callback.sensor_type == SensorType.ECG]
